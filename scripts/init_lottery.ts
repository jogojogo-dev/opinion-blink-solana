...
const mintAccount = new anchor.web3.PublicKey("So11111111111111111111111111111111111111112");
...
async function main() {
    ...
    const tx = await program.methods
        .initLotteryPool(poolId, new anchor.BN(4), new anchor.BN(10_000_000), new anchor.BN(10))
        .accounts({
