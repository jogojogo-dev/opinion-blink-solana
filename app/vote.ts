...
const voteProgramId = new PublicKey(
  "62TKbRM9rPsUu5kKeGUkoqP5M4CyLiVSogfaVT1uJFLQ"
);
const stateAccount = new PublicKey(
  "5QsxJuht8VuDfkf45RDj1Mw6su547NGCDE37pDwZ5xce"
);
...
export async function voteTransaction(voter: PublicKey, voteNumber: number) {
...
async function voteAccounts() {
  ...
  const voteAccounts =
    (await program.account.voteAccount.all()) as anchor.ProgramAccount<VoteAccount>[];
